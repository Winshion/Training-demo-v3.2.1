...
def format_word_cloud(job, text, path, encoding='utf-8'):
    ...
    wc = wordcloud.WordCloud(width=800, height=450, max_words=366,
                             background_color='white', font_path='../fonts/STZHONGS.TTF')
...
def store_plot(job_csv, job):
    ...
    fonts = matplotlib.font_manager.FontProperties(fname='./fonts/STZHONGS.TTF', size=12)
    ...
    plt.title(job + "岗位全国薪资水平：千元/月", fontproperties=fonts)
